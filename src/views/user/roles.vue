<template>
  <div class="app-container">
    ...
    <el-dialog :visible.sync="dialogVisible" :title="dialogType==='edit'?'编辑角色':'新增角色'" :append-to-body="true">
...
export default {
  ...
  methods: {
    ...
    i18n(routes) {
      ...
      var app = routes.map(function(route) {
        if (route.children) {
          route.children = _this.i18n(route.children)
        }
