  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on"
      ...
      <el-form-item prop="username">
        <el-input prefix-icon="el-icon-user-solid" ref="username" v-model="loginForm.username" placeholder="用户名"
      ...
      <el-tooltip v-model="capsTooltip" content="Caps lock is On" placement="right" manual>
        <el-form-item prop="password">
          ...
          <el-input prefix-icon="el-icon-lock" :key="passwordType" ref="password" v-model="loginForm.password"
            ...
            <i class="el-icon-view el-input__icon show-pwd" :class="passwordType === 'password' ? 'eye' : 'eye-open'"
              slot="suffix" @click="showPwd">
            </i>
          </el-input>
        </el-form-item>
      </el-tooltip>
